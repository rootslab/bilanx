...
log( '- running Bilanx#push 2^%d times, with command:', p, util.inspect( publish, false, 3, true ) );
...
log( '\n- check Bilanx internal queue size, should be:', k );
assert.equal( l.cqueue.size(), k );

log( '\n- now running Bilanx#pop 2^%d times', p );
